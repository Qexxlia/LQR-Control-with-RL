...
class PlotCallback(BaseCallback):
    ...
    def _on_rollout_end(self):
        ...
        self.logger.record("action/r1", vec_env.env_method("map_range", action[0,6], -1, 1, 0, 1)[0], exclude=("stdout", "log", "json", "csv"))
        self.logger.record("action/r2", vec_env.env_method("map_range", action[0,7], -1, 1, 0, 1)[0], exclude=("stdout", "log", "json", "csv"))
        self.logger.record("action/r3", vec_env.env_method("map_range", action[0,8], -1, 1, 0, 1)[0], exclude=("stdout", "log", "json", "csv"))
