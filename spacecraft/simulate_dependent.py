...
ax4.stairs(q_weights[:, 0], t_steps, label=r"$q_0$")
ax4.stairs(q_weights[:, 1], t_steps, label=r"$q_1$")
ax4.stairs(q_weights[:, 2], t_steps, label=r"$q_2$")
ax4.stairs(q_weights[:, 3], t_steps, label=r"$q_3$")
ax4.stairs(q_weights[:, 4], t_steps, label=r"$q_4$")
ax4.stairs(q_weights[:, 5], t_steps, label=r"$q_5$")
ax5.stairs(r_weights[:, 0], t_steps, label=r"$r_0$")
ax5.stairs(r_weights[:, 1], t_steps, label=r"$r_1$")
ax5.stairs(r_weights[:, 2], t_steps, label=r"$r_2$")
